...
module.exports = (story) => {
    ...
    output += `Having gathered enough friends to begin ${story.protagonist.pronoun.possessive} journey, ${story.protagonist.name} sets out with ${story.protagonist.pronoun.possessive} newly-assembled party to brave the dangers on the way to the lair of ${story.antagonist.title}...`;
